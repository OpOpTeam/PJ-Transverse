-- V_3 DATABASE [Ajout de plus de recettes pour plus de plaisir!]
...
INSERT INTO `cook_book`.`ingredient` (`nom_ingr`, `type`) VALUES ('Farine fleur de Maïs', 'Epicerie sucré');
...
INSERT INTO `cook_book`.`ingredient` (`nom_ingr`, `type`) VALUES ('Cuisse de poulet', 'Viande');
INSERT INTO `cook_book`.`ingredient` (`nom_ingr`, `type`) VALUES ('Pain d épice', 'Féculent');
INSERT INTO `cook_book`.`ingredient` (`nom_ingr`, `type`) VALUES ('Bière brune (type pelfort)', 'Condiment');

INSERT INTO `cook_book`.`ingredient` (`nom_ingr`, `type`) VALUES ('Farine de blé noir', 'Epicerie sucré');
INSERT INTO `cook_book`.`ingredient` (`nom_ingr`, `type`) VALUES ('Farine de froment', 'Epicerie sucré');
...
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('1', 'NULL', '24', '114'); -- 1 cuisse de poulet avec la peau
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('50', 'g', '24', '19'); -- 50 g de lardons fumés
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('0.5', 'NULL', '24', '5'); -- 1/2 oignons
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('0.5', 'tranche', '24', '115'); -- 1/2 tranche de pain d'épices
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('0.25', 'bouteille', '24', '116'); -- 1/4 bouteille de bière brune
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('1', 'pincée', '24', '21'); -- poivre du moulin

INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('17', 'g', '25', '117'); -- 17g de farine de blé noir
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('5', 'g', '25', '118'); -- 5g de farine de froment
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('0.1', 'cuillère à soupe', '25', '5'); -- 1/10 cuillère à soupe de huile
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('0.1', 'cuillère à café', '25', '115'); -- 1/10 cuillère a café de sel
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('0.05', 'l', '25', '59'); -- 1/20 eau
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('0.5', 'tranche', '25', '72'); -- 1/2 tranche de jambon
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('2', 'NULL', '25', '44'); -- 2 oeuf
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('10', 'g', '25', '73'); -- 10g de gruyere

INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('1', 'NULL', '26', '119'); -- 1 bagel
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('2', 'tranche', '26', '120'); -- 2 tranches saumon fumé
INSERT INTO `cook_book`.`possede_rc_ing` (`quantite`, `mesure`, `ID_recette`, `ID_ingr`) VALUES ('1', 'NULL', '26', '36'); -- Fromage frais
